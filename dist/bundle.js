...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n/* harmony import */ var _module_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module/api.js */ \"./src/module/api.js\");\n/* harmony import */ var _module_leaderboard_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./module/leaderboard.js */ \"./src/module/leaderboard.js\");\n\n\n\n\nlet gameID = null;\n\nconst initializeGame = async () => {\n  try {\n    const gameName = 'SuperHero';\n    const game = await (0,_module_api_js__WEBPACK_IMPORTED_MODULE_1__.createGame)(gameName);\n    gameID = game.result;\n  } catch (error) {\n    // eslint-disable-next-line no-console\n    console.error('Error al crear el juego:', error);\n  }\n};\n\nconst handleRefresh = async () => {\n  if (!gameID) {\n    await initializeGame();\n  }\n\n  if (gameID) {\n    const scores = await (0,_module_api_js__WEBPACK_IMPORTED_MODULE_1__.fetchData)(gameID);\n    (0,_module_leaderboard_js__WEBPACK_IMPORTED_MODULE_2__.renderLeaderboard)(scores);\n  }\n};\n\nconst handleSubmit = async (event) => {\n  event.preventDefault();\n\n  const nameInput = document.getElementById('nameInput');\n  const scoreInput = document.getElementById('scoreInput');\n\n  if (!gameID) {\n    await initializeGame();\n  }\n\n  const name = nameInput.value.trim();\n  const score = parseInt(scoreInput.value, 10);\n\n  // eslint-disable-next-line no-restricted-globals\n  if (name === '' || isNaN(score)) {\n    // eslint-disable-next-line no-alert\n    alert('Por favor, ingresa un nombre y una puntuación válida.');\n    return;\n  }\n\n  await (0,_module_api_js__WEBPACK_IMPORTED_MODULE_1__.postData)(gameID, name, score);\n\n  nameInput.value = '';\n  scoreInput.value = '';\n\n  handleRefresh();\n};\n\nconst refreshButton = document.getElementById('refreshButton');\nconst scoreForm = document.getElementById('scoreForm');\n\nrefreshButton.addEventListener('click', handleRefresh);\nscoreForm.addEventListener('submit', handleSubmit);\n\nhandleRefresh();\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
...
eval("module.exports = __webpack_require__.p + \"a9729c51749834686599.webp\";\n\n//# sourceURL=webpack://leaderboard/./src/img/mario.webp?");
